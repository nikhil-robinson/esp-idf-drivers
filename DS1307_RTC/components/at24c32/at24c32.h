...
// // static esp_err_t ReadReg32(EEPROM_t * dev, i2c_port_t i2c_port, int chip_addr, uint16_t data_addr, uint32_t * data);
// // static esp_err_t WriteReg32(EEPROM_t * dev, i2c_port_t i2c_port, int chip_addr, uint16_t data_addr, uint32_t data);
