...
#define TX_GPIO_NUM                     43
#define RX_GPIO_NUM                     44
...
static twai_message_t data_message = {.identifier = ID_SLAVE_DATA, .data_length_code = 1,
                                     .data = {0, 0 , 0 , 0 ,0 ,0 ,0 ,0}};
